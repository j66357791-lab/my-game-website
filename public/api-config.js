...
const API_CONFIG = {
    // 基础配置 - 修改为您的真实服务器地址
    BASE_URL: 'https://my-game-website-5uz0.onrender.com/api',
    TIMEOUT: 10000,
    VERSION: '1.0.0',
    
    // 数据源配置
    USE_MOCK: false,        // 设置为false使用真实API
    DATA_SOURCE: 'server',   // 设置为'server'使用服务器数据
    ...
    ENDPOINTS: {
        ...
        GAMES: {
            ...
            DOLL_KING_GET_DATA: '/games/doll-king/data',
            DOLL_KING_SAVE_DATA: '/games/doll-king/save',
            DOLL_KING_SYNC_DATA: '/games/doll-king/sync'
        },
