...
const FamilyPark = {
                    ...
                    <div class="no-family">
                        ...
                        <div class="create-family-info">
                            ...
                            <div class="info-item">
                                ...
                                <span>每人只能创建一个家庭</span>
                            </div>
                            <div class="info-item">
                                <i class="fas fa-shield-alt"></i>
                                <span>有家庭后无法加入其他家庭</span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" id="family-name-input" class="form-control" placeholder="请输入家庭名称" maxlength="20">
                            <small class="form-help">家庭名称将显示给所有成员</small>
                        </div>
    ...
    async createFamily() {
        try {
            ...
            if (hasFamily) {
                this.showNotification('您已经有家庭了，无法创建新家庭', 'error');
                return;
            }
