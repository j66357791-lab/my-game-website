...
const Admin = {
    ...
    async updateTransferSettings() {
        const userFeeRate = parseFloat(document.getElementById('user-fee-rate').value) || 5;
        const merchantBonusRate = parseFloat(document.getElementById('merchant-bonus-rate').value) || 1;
        const baseBonusRate = parseFloat(document.getElementById('base-bonus-rate').value) || 1;
    ...
    async handleMerchantAppointment(e) {
        ...
        const username = document.getElementById('appointment-username').value;
    ...
    calculateDailyIncome() {
        Utils.showNotification('计算今日收益功能开发中...', 'info');
    },
