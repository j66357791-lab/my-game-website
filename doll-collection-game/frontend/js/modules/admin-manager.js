...
const AdminManager = {
    ...
    async adjustUserPoints(userId) {
        ...
        try {
            const response = await fetch(`${this.API_BASE}/adjust-points`, {
                method: 'POST',
                headers: {
    ...
    async toggleUserStatus(userId) {
        ...
        try {
            const response = await fetch(`${this.API_BASE}/toggle-user-status`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
    ...
    async editUser(userId) {
        ...
        try {
            const response = await fetch(`${this.API_BASE}/edit-user`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
    ...
    async deleteDoll(dollId) {
        ...
        try {
            const response = await fetch(`${this.API_BASE}/delete-doll`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
    ...
    async handleBatchGrant(e) {
        ...
        try {
            const response = await fetch(`${this.API_BASE}/grant-points`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (parseFloat(points) !== 1000) {
                    const userResponse = await fetch(`${this.API_BASE}/users`, {
                        headers: {
                            'Authorization': `Bearer ${localStorage.getItem('token')}`
                        }
                    });
                    ...
                    if (userResponse.ok) {
                        ...
                        if (newUser) {
                            await fetch(`${this.API_BASE}/adjust-points`, {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'Authorization': `Bearer ${localStorage.getItem('token')}`
    ...
    async updateDollPrices() {
        ...
        try {
            const response = await fetch(`${this.API_BASE}/update-system-config`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
