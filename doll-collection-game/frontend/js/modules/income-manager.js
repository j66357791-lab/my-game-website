...
const IncomeManager = {
    ...
    async processDailyPayout() {
        ...
        try {
            ...
            // 添加交易记录
            this.addTransactionRecord(totalIncome, '每日收益发放');
    ...
    // 添加交易记录
    addTransactionRecord(amount, description) {
        ...
        // 更新交易记录显示
        if (window.UserDataManager) {
            UserDataManager.showTransactionHistory();
        }
    },
