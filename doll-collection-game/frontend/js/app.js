...
function calculateDailyIncome() {
    ...
    try {
        ...
        .then(data => {
            ...
            const activeDolls = allDolls.filter(doll => doll && doll.active);
...
function loadDollFilters() {
    ...
    filtersContainer.innerHTML = `
        <div class="filter-row" style="display: flex; gap: 15px; margin-bottom: 20px; flex-wrap: wrap;">
            <div class="filter-group">
                <label style="display: block; margin-bottom: 5px; font-weight: bold;">等级筛选:</label>
            ...
            <div class="filter-group">
                <label style="display: block; margin-bottom: 5px; font-weight: bold;">用户搜索:</label>
            ...
            <div class="filter-group">
                <label style="display: block; margin-bottom: 5px; font-weight: bold;">日期范围:</label>
            ...
            <div class="filter-group">
                ...
                <button class="btn btn-secondary" onclick="resetDollFilters()"
