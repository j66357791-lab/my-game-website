...
function initAdminNavigation() {
    ...
    menuItems.forEach(item => {
        item.addEventListener('click', (e) => {
            ...
            const targetPage = item.getAttribute('data-admin-page');
...
function loadDashboardData() {
    ...
    // 模拟数据更新
    setTimeout(() => {
        document.getElementById('total-users-count').textContent = '1,234';
        document.getElementById('total-dolls-count').textContent = '5,678';
        document.getElementById('total-transactions-count').textContent = '9,012';
        document.getElementById('today-income').textContent = '3,456';
    }, 500);
}
...
function loadUserStats() {
    ...
    setTimeout(() => {
        ...
        document.getElementById('active-users-today').textContent = '156';
        document.getElementById('total-active-users').textContent = '892';
        document.getElementById('user-retention-rate').textContent = '78.5%';
    }, 500);
}

// 加载娃娃统计数据
function loadDollStats() {
    console.log('加载娃娃统计数据...');
    
    setTimeout(() => {
        document.getElementById('level1-dolls-count').textContent = '2,345';
        document.getElementById('level2-dolls-count').textContent = '1,678';
        document.getElementById('level3-dolls-count').textContent = '890';
        document.getElementById('synthesis-success-rate').textContent = '85.2%';
    }, 500);
}

// 加载交易统计数据
function loadTransactionStats() {
    console.log('加载交易统计数据...');
    
    setTimeout(() => {
        document.getElementById('today-transactions').textContent = '234';
        document.getElementById('today-revenue').textContent = '12,345';
        document.getElementById('month-transactions').textContent = '5,678';
        document.getElementById('month-revenue').textContent = '234,567';
    }, 500);
}

// 加载娃娃价格设置
function loadDollPrices() {
    console.log('加载娃娃价格设置...');
    // 价格已经在HTML中设置，这里可以调用API获取最新价格
}

// 加载系统设置
function loadSystemSettings() {
    console.log('加载系统设置...');
    // 设置已经在HTML中设置，这里可以调用API获取最新设置
}

// 加载系统日志
function loadSystemLogs() {
    console.log('加载系统日志...');
    // 日志已经在HTML中显示，这里可以调用API获取最新日志
}
...
function resetPrices() {
    if (confirm('确定要重置所有价格为默认值吗？')) {
        document.getElementById('level1-price').value = 50;
        document.getElementById('level2-price').value = 210;
        document.getElementById('level3-price').value = 500;
        alert('价格已重置为默认值');
    }
}
