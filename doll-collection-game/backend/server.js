...
// 提供CSS和JS文件
app.get('/css/racing.css', (req, res) => {
    res.sendFile(path.join(__dirname, 'frontend/css/racing.css'));
});

app.get('/js/racing.js', (req, res) => {
    res.sendFile(path.join(__dirname, 'frontend/js/racing.js'));
});
