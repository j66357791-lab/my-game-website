...
const spaceGameRoutes = require('./routes/space-game'); // 添加太空挑战路由
...
app.use('/api/space-game', spaceGameRoutes); // 添加太空挑战游戏路由
...
// 太空挑战游戏路由
app.get('/space-game', (req, res) => {
    res.sendFile(path.join(__dirname, '../frontend/space-game/index.html'));
});
...
app.use('/space-game/css', express.static(path.join(__dirname, '../frontend/space-game/css')));
app.use('/space-game/js', express.static(path.join(__dirname, '../frontend/space-game/js')));
