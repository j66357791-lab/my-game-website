...
// 获取当前游戏状态
app.get('/api/animal-game/current-round', async (req, res) => {
    try {
...
// 投注
app.post('/api/animal-game/bet', async (req, res) => {
    try {
...
// 获取玩家统计
app.get('/api/animal-game/stats/:userId', async (req, res) => {
    try {
...
// 获取历史记录
app.get('/api/animal-game/history', async (req, res) => {
    try {
