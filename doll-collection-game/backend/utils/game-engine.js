...
const User = require('../models/User');  // 修复：路径错误
const Transaction = require('../models/Transaction');  // 修复：路径错误
        ...
        if (totalWinnerBet > 0 && prizePool > 0) {
            for (const room of winnerRooms) {
                for (const player of room.players) {
                    ...
                    console.log(`🎉 积分更新结果:`, userUpdateResult);
                    ...
                    console.log(`🎉 统计更新结果:`, statsUpdateResult);
