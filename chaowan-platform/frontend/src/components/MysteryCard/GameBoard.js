// frontend/src/components/MysteryCard/GameBoard.js - 完整修复版（路径已修正）
import React, { useState, useEffect } from 'react';
// 🔧 修正：使用 2 个点 (../../) 返回 src 目录
...
const GameBoard = ({ gameState }) => {
  ...
  // 🔧 修复：使用 updateUser 代替 setUser（更安全）
