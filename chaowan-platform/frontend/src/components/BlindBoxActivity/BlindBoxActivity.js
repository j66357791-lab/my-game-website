// frontend/src/components/BlindBoxActivity/BlindBoxActivity.js
...
const BlindBoxActivity = ({ user, globalPoints, syncUserData }) => {
  ...
  const loadActivityData = useCallback(async () => {
    try {
      const data = await api.get('/blindBox/activity');
      ...
      <div className="main-blindbox">
        ...
        <div className="draw-buttons">
          ...
          <button 
            ...
            disabled={isDrawing || (globalPoints || activityData.userPoints) < 899}
          >
