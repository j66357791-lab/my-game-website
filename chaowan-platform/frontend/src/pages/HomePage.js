...
const HomePage = ({ user, onUpdateUser }) => {
  ...
  const announcements = useMemo(() => [
    ...
    { id: 3, title: '🎁 盲盒天天乐', content: '新活动上线！抽取字符兑换红包奖励！', type: 'event', link: '/blindBox-activity' },
    { id: 4, title: '📢 经济模型更新', content: '娃娃等级与回收系统已上线，体验更完善！', type: 'notice' }
  ], []);
  ...
  return (
    <div className="home-page">
      ...
      {/* 🆕 新增：盲盒活动卡片 */}
      <div className="blindBox-activity-card" onClick={() => navigateToPage('/blindBox-activity')}>
        <div className="blindBox-header">
          <h3>🎁 盲盒天天乐</h3>
          <div className="activity-badge">限时活动</div>
        </div>
        <div className="blindBox-content">
          <div className="blindBox-preview">
            <div className="floating-chars">
              <span className="char char-1">内</span>
              <span className="char char-2">测</span>
              <span className="char char-3">红</span>
              <span className="char char-4">包</span>
              <span className="char char-5">天</span>
              <span className="char char-6">天</span>
              <span className="char char-7">领</span>
            </div>
          </div>
          <div className="blindBox-info">
            <p className="activity-desc">抽取盲盒收集字符，兑换红包奖励！</p>
            <div className="reward-preview">
              <span className="reward-item">单字 ¥0.88</span>
              <span className="reward-item">内测 ¥1.58</span>
              <span className="reward-item">红包 ¥3.88</span>
            </div>
          </div>
        </div>
        <div className="blindBox-footer">
          <span className="activity-period">12.8-12.30</span>
          <span className="enter-activity">进入活动 ›</span>
        </div>
      </div>
        ...
        <div className="announcements-list">
          {announcements.map((announcement) => (
            <div 
              ...
              onClick={() => announcement.link && navigateToPage(announcement.link)}
