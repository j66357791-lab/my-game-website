...
const HomePage = ({ user, onUpdateUser }) => {
  ...
  return (
    <div className="home-page">
      ...
      {/* 🔧 新增：盲盒活动卡片 */}
      <div className="feature-card blindbox-activity-card" onClick={() => navigateToPage('/blindBox-activity')}>
        <div className="card-header">
          <h3>🎁 盲盒天天乐</h3>
          <span className="activity-badge">进行中</span>
        </div>
        <div className="card-content">
          ...
          <div className="blindbox-info">
            <p className="activity-desc">收集字符兑换红包奖励</p>
            <div className="reward-preview">
              <span className="reward-item">¥0.88</span>
              <span className="reward-item">¥1.58</span>
              <span className="reward-item">¥3.88</span>
              <span className="reward-item">¥9.88</span>
            </div>
          </div>
        </div>
