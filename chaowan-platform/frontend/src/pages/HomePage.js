// src/pages/HomePage.js - V7.4.2 性能优化版
...
const HomePage = ({ user, onUpdateUser }) => {
  ...
  }, [refreshing, onUpdateUser, refreshData]);
    ...
    <div className="home-page">
      ...
      <div className="my-dolls-card">
        <div className="dolls-header">
          <h3>🧸 我的娃娃</h3>
          {dolls.length > 4 && (
            <button className="view-all-btn" onClick={() => window.location.href = '/profile'}>查看全部 ›</button>
          )}
        </div>
        {dolls.length > 0 ? (
          ...
          {featuredDolls.map((doll) => (
            <div key={doll.id} className="featured-doll">
              ...
              <div className="featured-price">
                ...
                {doll.price > 0 ? (
                  <button className="buy-btn" onClick={() => window.location.href = '/doll-shop'}>购买</button>
                ) : (
