...
const MysteryCardPage = ({ user }) => {
  ...
  return (
    <div className="mystery-card-page">
      ...
      {/* 🔥 核心修复：只有当 gameState 存在时才渲染 GameBoard，防止崩溃 */}
      <div className="game-container">
        {gameState ? (
          ...
          // 如果 gameState 为 null，显示一个占位符或保持 Loading 状态
          !isLoading && <div style={{color: 'white', textAlign: 'center', marginTop: '50px'}}>正在同步游戏数据...</div>
        )}
      </div>
    </div>
  );
