// src/pages/DollCenterPage.js - 修复数据同步和VIP功能
...
const DollCenterPage = () => {
  ...
  }, [activeTab, loadUserData, loadBossData, loadVipData, loadSynthesisData]);
        ...
        <div className="privileges-list">
          <div className="privilege-item">
            ...
            <div className="privilege-info">
              ...
              <div className="privilege-desc">每日可登录领取专属星源币奖励</div>
            </div>
          </div>
          <div className="privilege-item">
            <span className="privilege-icon">🎁</span>
            <div className="privilege-info">
              <div className="privilege-name">超值回报</div>
              <div className="privilege-desc">VIP期间累计可获得大量星源币</div>
            </div>
          </div>
          <div className="privilege-item">
            <span className="privilege-icon">🚀</span>
