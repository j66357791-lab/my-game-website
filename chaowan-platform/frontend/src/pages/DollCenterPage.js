// src/pages/DollCenterPage.js - 最终修复版 (修正变量顺序 + 依赖项)
...
const DollCenterPage = () => {
  ...
  // 🔧 修复1：将 handleModuleClick 移到 featureModules 之前
  const handleModuleClick = (moduleId) => {
    console.log('点击模块:', moduleId);
    setActiveTab(moduleId);
  };

  // 🔧 修复2：getBaseHeaders 移到前面，避免引用顺序问题
  ...
  // 功能模块配置 (现在可以安全地引用 handleModuleClick)
  ...
  // 🔧 修复3：useEffect 依赖项修正，包含 forceRefreshUserData
  useEffect(() => {
