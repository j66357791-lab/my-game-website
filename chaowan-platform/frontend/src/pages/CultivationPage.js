...
import './CultivationPage.css'; // 确保该文件存在（与 CultivationPage.js 同级）
import { cultivationService } from '../services/cultivationService';
import AttributeList from '../components/Cultivation/AttributeList'; // 修正导入路径
  ...
  return (
    <div className="cultivation-container">
      ...
      <div className="attributes-panel">
        ...
        <AttributeList attributes={data.attributes} /> {/* 使用修正后的属性列表组件 */}
      </div>
