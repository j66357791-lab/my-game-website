// frontend/src/contexts/UserContext.js - 最终修复版 (包含 Token 导出)
...
export const UserProvider = ({ children }) => {
  ...
  const [lastTaskCheckDate, setLastTaskCheckDate] = useState('');
