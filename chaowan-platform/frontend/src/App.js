// frontend/src/App.js - 修正文件名引用
import React, { useState, useEffect } from 'react';
import { BrowserRouter, Routes, Route, Navigate, useNavigate, useLocation } from 'react-router-dom';
import api from './config/api.js';
import { UserProvider, useUser } from './contexts/UserContext';
import HomePage from './pages/HomePage';
import DollCenterPage from './pages/DollCenterPage'; // ✅ 正确：DollCenterPage
import GameCenterPage from './pages/GameCenterPage'; // 保持原有游戏中心
...
import TurtleRabbitRacePage from './pages/TurtleRabbitRacePage'; // 新增：龟兔赛跑游戏页面
import './App.css';
