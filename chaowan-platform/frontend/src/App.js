// frontend/src/App.js - 完整版（包含新的游戏管控页面）
...
// 🔧 新增：引入游戏管控页面
import AdminMysteryCardPage from './pages/admin/AdminMysteryCardPage';
              ...
              <Routes>
                ...
                {isAdmin && (
                  <>
                    ...
                    {/* 🔧 新增：神秘卡牌游戏管控页面 */}
                    <Route 
                      path="/admin/mystery-card" 
                      element={<AdminMysteryCardPage user={user} onUpdateUser={handleUpdateUser} />} 
                    />
