...
const AFFIX_POOL = {
  red: [ { name: '灵气获取+10%', type: 'spiritRate', value: 0.1 }, { name: '攻击+20', type: 'attack', value: 20 }, { name: '生命+300', type: 'health', value: 300 }, { name: '防御+15', type: 'defense', value: 15 }, { name: '速度+10', type: 'speed', value: 10 }, { name: '暴击+5%', type: 'critRate', value: 0.05 }, { name: '闪避+5%', type: 'dodgeRate', value: 0.05 }, { name: '抗暴+8%', type: 'antiCritRate', value: 0.08 }, { name: '抗闪+8%', type: 'antiDodgeRate', value: 0.08 }, ],
  orange: [ { name: '灵气+5%', type: 'spiritRate', value: 0.05 }, { name: '攻击+10', type: 'attack', value: 10 }, { name: '生命+150', type: 'health', value: 150 }, { name: '防御+10', type: 'defense', value: 10 }, { name: '速度+5', type: 'speed', value: 5 }, { name: '暴击+2%', type: 'critRate', value: 0.02 }, { name: '闪避+2%', type: 'dodgeRate', value: 0.02 }, { name: '抗暴+4%', type: 'antiCritRate', value: 0.04 }, { name: '抗闪+4%', type: 'antiDodgeRate', value: 0.04 }, ],
  purple: [ { name: '灵气+3%', type: 'spiritRate', value: 0.03 }, { name: '攻击+5', type: 'attack', value: 5 }, { name: '生命+50', type: 'health', value: 50 }, { name: '防御+5', type: 'defense', value: 5 }, { name: '速度+3', type: 'speed', value: 3 }, { name: '暴击+1%', type: 'critRate', value: 0.01 }, { name: '闪避+1%', type: 'dodgeRate', value: 0.01 }, { name: '抗暴+2%', type: 'antiCritRate', value: 0.02 }, { name: '抗闪+2%', type: 'antiDodgeRate', value: 0.02 }, ],
  blue: [ { name: '灵气+1%', type: 'spiritRate', value: 0.01 }, { name: '攻击+3', type: 'attack', value: 3 }, { name: '生命+30', type: 'health', value: 30 }, { name: '防御+3', type: 'defense', value: 3 }, { name: '速度+1', type: 'speed', value: 1 }, ],
  white: [ { name: '攻击+1', type: 'attack', value: 1 }, { name: '生命+10', type: 'health', value: 10 }, { name: '防御+1', type: 'defense', value: 1 }, ]
};
...
// ✅ 核心修复：统一计算接口
// 返回 { totalAttributes, realCombatPower, dollObj }
const calculateDollFullStats = async (dollDoc) => {
  // 1. 强制重新加载并填充装备
  const doll = await ImmortalDoll.findOne({ _id: dollDoc._id })
  ...
  return {
    ...
    realCombatPower: cp,
    doll // 返回 populate 后的 doll 对象，避免重复查询
  };
};
...
const createFixedEquip = (userId, slot) => {
  ...
  return new ImmortalEquipment({
    userId, slot, level: 0, star: 0, quality: 'common',
    attributes: baseStats, affixes: []
  });
};
