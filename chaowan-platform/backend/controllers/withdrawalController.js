// backend/controllers/withdrawalController.js - 修复版 (req.user._id)
...
const createWithdrawal = async (req, res) => {
  try {
    ...
    const userId = req.user._id; // ✅ 修正: req.user.id -> req.user._id
...
const processWithdrawal = async (req, res) => {
  try {
    ...
    const adminId = req.user._id; // ✅ 修正: req.user.id -> req.user._id
