...
const bcrypt = require('bcryptjs'); // 🔧 必须引入 bcryptjs
    ...
    res.status(201).json({
      ...
      data: {
        user: {
          ...
          starcoin: newUser.starcoin.toFixed(2), 
    ...
    res.status(200).json({
      ...
      data: {
        user: {
          ...
          level: user.level,
          points: user.points,
          starcoin: user.starcoin.toFixed(2), 
    ...
    res.status(200).json({
      ...
      data: {
        user: {
          ...
          level: user.level,
          points: user.points,
          starcoin: parseFloat(user.starcoin).toFixed(2), 
          cashBalance: user.cashBalance,
          experience: user.experience,
          role: user.role
        }
