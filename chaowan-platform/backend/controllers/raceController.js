// backend/controllers/raceController.js - 彻底修复版本
...
const startRace = async (req, res) => {
  try {
    ...
    if (isWin) {
      ...
      console.log('💰 创建奖励交易记录:', rewardTransaction._id);
    }

    console.log('💰 创建投注交易记录:', betTransaction._id);
    ...
    console.log('📝 创建游戏历史记录:', raceRecord._id);
