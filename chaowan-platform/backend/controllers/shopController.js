// backend/controllers/shopController.js - 完整修复版 (含1:10汇率)
  ...
  try {
    ...
    for (const item of items) {
      ...
      orderItems.push({
        ...
        price: itemPoints + (itemCash * SHOP_CONFIG.EXCHANGE_RATE)
      });
    ...
    // 1:10 汇率计算：1元 = 10积分 (后端 constants.js 已改为 10，这里自动生效)
