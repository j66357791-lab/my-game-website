...
// ==================== 🔧 新增：神秘卡牌后台管控接口 ====================
// 注意：这些接口必须挂载在 adminAuth 中间件之后，确保只有管理员能访问

// 🔧 获取游戏控制配置
app.get('/api/admin/mystery-card/config', adminAuth, getMysteryCardConfig);

// 🔧 更新游戏控制配置 (强制点数/概率)
app.post('/api/admin/mystery-card/config', adminAuth, updateMysteryCardConfig);

// 🔧 获取财务统计数据 (流水/派发/走势)
app.get('/api/admin/mystery-card/stats', adminAuth, getMysteryCardStats);
