...
app.get('/api/admin/users', adminAuth, async (req, res) => {
  try {
    ...
    console.log(`📊 处理用户列表: page=${page}, limit=${limit}, search="${search}", sortBy="${sortBy}"`);
    ...
    console.log(`📊 查询参数: skip=${skip}, limit=${limitNum}`);
    ...
    console.log(`✅ 查询结果: 找到 ${users.length} 个用户，总数 ${total}`);
